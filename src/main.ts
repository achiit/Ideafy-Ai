...
import { initializeTelegramClient } from './main/telegram_client';
...
const createWindow = () => {
  ...
  mainWindow = new BrowserWindow({
    ...
    webPreferences: {
      ...
      sandbox: false, // This is required for the preload script to work
      // transparent: true,
    },
...
app.on("render-process-gone", (event, webContents, details) => {
  console.log(`App#render-process-gone: ${JSON.stringify(details)}`);
});
